...
class NodoLista:
    '''
    Funciones para crear, consultar y modificar un nodo de la lista doblemente encadenada.
    Un nodo se define por los datos info (elemento), 
    el next (conexion al proximo nodo de la lista) y 
    el previous (conexion al anterior nodo de la lista)
    '''
    def __init__(self, infoNodo):
        ...
        self.previous = None   # self.next contiene la referencia al anterior nodo
    ...
    def getPrevious(self):
        '''
        Retorna la referencia al anterior nodo del nodo self
    ...
    def setPrevious(self, nodoPrev):
        '''
        Modifica la referencia al anterior nodo del nodo self
        Args:
            referencia al nuevo nodo anterior del nodo self

        Ejemplo de uso en las funciones de la Lista:
            nodo.setPrevious(nodoAnterior)
        '''
        self.previous = nodoPrev

class listaEnlazada():
    '''
    Clase que representa una Lista Doblemente Enlazada que inicia en el primer nodo (first).
    '''
    ...
    def __init__(self, type):
        ...
        Args:
            type: 2 si la lista es doblemente
    ...
    def size(self):
        ...
        Returns:
            Numero el numero de elementos en la lista
        '''
    ...
    def addNode_byValue(self, infoNodo):
        '''
        Añade un NUEVO nodo al FINAL lista doblemente enlazada
    ...
    def findAdjacentNode(self, infoNodo):
        '''
        Devuelve el elemento de los nodos adyacentes al nodo que contiene infoNodo. 
        Para la lista doblemente enlazada, los adyacentes de un nodo es la informacion de su nodo anterior (si existe) y 
        la informacion de su nodo siguiente (si existe)

        Args:
            infoNodo: Información del nodo al que se le busca su adyacente 

        Returns:
            Lista (python) con los elementos de los nodos adyacentes al nodo dado. 
